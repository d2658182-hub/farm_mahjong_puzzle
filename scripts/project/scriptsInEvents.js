...
window.idAsyncInit = function() {
	...
	ID.init({
        ...
        //appId : "66a7196c92b8d16398ee93a8"
		appId : "679afb806025e16b3bbfa763"
    });
};
...
const scriptsInEvents = {
	...
	{
		ID.api('user_data/remove', 'POST', {key: localVars.saveKey_}, function(response){
		    console.log(response);
		});
	},
	...
	async Y8api_Event19_Act2(runtime, localVars)
	{
	...
	async Y8api_Event21_Act1(runtime, localVars)
	{
	...
	async Y8api_Event23_Act2(runtime, localVars)
	{
		
	},

	async Y8api_Event40_Act1(runtime, localVars)
	{
